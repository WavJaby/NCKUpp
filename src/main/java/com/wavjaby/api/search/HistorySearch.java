...
public class HistorySearch implements Module {
    ...
    public void start() {
        ...
        sqlDriver = new SQLDriver("course_data.mv.db", "jdbc:h2:./course_data;AUTO_SERVER=TRUE;TRACE_LEVEL_SYSTEM_OUT=0",
        ...
        try {
            ...
            addCourseStat = connection.prepareStatement("insert into COURSE_113_1 (" +
    ...
    private synchronized List<CourseData> getCourse(String deptId, Integer serialNumber,
        ...
        try {
            ...
            while (result.next()) {
                ...
                HistoryCourseData historyCourseData = new HistoryCourseData("1131", tagIds, instructorIds, finalTimes, result);
    ...
    public void writeDatabase() {
        ...
        allCourseDataListTW.sort((a, b) -> {
            if (!Objects.equals(a.departmentId, b.departmentId))
                return String.valueOf(a.departmentId).compareTo(String.valueOf(b.departmentId));
            if (!Objects.equals(a.serialNumber, b.serialNumber))
                return String.valueOf(a.serialNumber).compareTo(String.valueOf(b.serialNumber));
            if (!Objects.equals(a.systemCode, b.systemCode))
                return String.valueOf(a.systemCode).compareTo(String.valueOf(b.systemCode));
            return String.valueOf(a.attributeCode).compareTo(String.valueOf(b.attributeCode));
        });
...
//            CourseData courseDataEN = allCourseDataListEN.get(i);
            CourseData courseDataEN = courseSerialMapEN.get(keyTW);
            String keyEN;
            if (courseDataEN == null) {
                logger.warn("Course en data not found: " + keyTW);
                keyEN = keyTW;
                courseDataEN = courseDataTW;
            } else keyEN = getCourseKey(courseDataEN);


            String keyWithClassTW = keyTW + '_' + courseDataTW.forClass;
...
//        saveCookieCache(cookieCache);
    ...
    private void search(Language language, CourseHistorySearchQuery historySearch) {
        // Load cookies
